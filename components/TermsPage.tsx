...
const TermsPage: React.FC<TermsPageProps> = ({ onClose, lang }) => {
  const contentMap = {
    ...
    ta: {
      ...
      sections: [
        { head: "01. ஒப்பந்தம்", body: "ஒரின் AI ஐப் பயன்படுத்துவதன் மூலம், இந்த அடிப்படை விதிகளுக்கு நீங்கள் உடன்படுகிறீர்கள். இந்த விதிமுறைகள் அவ்வப்போது புதுப்பிக்கப்படலாம்." },
        { head: "02. நியாயமான பயன்பாடு", body: "இந்த தளத்தை கல்வி மற்றும் ஆக்கபூர்வமான பணிகளுக்கு மட்டுமே பயன்படுத்தவும். சட்டவிரோதமான அல்லது மற்றவர்களுக்கு தீங்கு விளைவிக்கும் உள்ளடக்கத்தை உருவாக்குவது தடைசெய்யப்பட்டுள்ளது." },
        { head: "03. AI துல்லியம்", body: "செயற்கை நுண்ணறிவு சில நேரங்களில் தவறான பதில்களை வழங்கலாம் (Hallucinations). முக்கியமான முடிவுகளை எடுப்பதற்கு முன் தகவல்களை சரிபார்க்கவும்." },
        { head: "04. படைப்புகளின் உரிமை", body: "ஒரின் மூலம் நீங்கள் உருவாக்கும் அனைத்து படங்கள் மற்றும் உரைகளின் உரிமை உங்களுக்கே உரியது. நீங்கள் அவற்றை எந்தப் பணிக்கும் பயன்படுத்தலாம்." },
        { head: "05. பொறுப்பு", body: "தொழில்நுட்ப கோளாறுகளால் ஏற்படும் இழப்புகளுக்கு நாங்கள் பொறுப்பேற்க மாட்டோம். சேவையை 'உள்ளபடியே' (As-is) வழங்குகிறோம்." },
        { head: "06. சட்டம்", body: "இந்த விதிமுறைகள் இலங்கையின் சட்டங்களுக்கு உட்பட்டது. ஏதேனும் பிரச்சனைகள் ஏற்பட்டால், அது இலங்கை நீதிமன்ற அதிகார வரம்பிற்குள் தீர்க்கப்பட வேண்டும்." }
      ],
    ...
    en: {
      ...
      sections: [
        ...
        { head: "06. Legal Disputes", body: "These terms are governed by the laws of Sri Lanka. Any disputes shall be handled within the jurisdiction of Sri Lankan courts." }
      ],
        ...
        <div className="space-y-12">
          {content.sections.map((s, i) => (
            <section key={i} className="animate-reveal space-y-4" style={{ animationDelay: `${i * 0.05}s` }}>
              ...
              <p className="text-slate-600 dark:text-slate-400 font-medium leading-relaxed indent-4">{s.body}</p>
            </section>
          ))}
