...
const FeatureVision: React.FC<FeatureVisionProps> = ({ onClose, lang = 'en' }) => {
  return (
    <div className="h-full w-full overflow-y-auto p-6 bg-slate-50 dark:bg-slate-950">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-wider">Vision</h2>
        <p className="text-sm text-slate-500 mt-2">Feature: Vision mode.</p>
        {onClose && (
