...
export type AppView = 'landing' | 'chat' | 'translator' | 'art' | 'camera' | 'voice' | 'math' | 'agent' | 'files' | 'community' | 'account' | 'privacy' | 'terms' | 'releases' | 'logic' | 'creator' | 'downloads' | 'admin-portal' | 'telegram-bot' | 'executor' | 'device-auth';
